...
|----------|-------------|
| [Architecture Overview](docs/specs/01-architecture-overview.md) | System design, components, deployment model |
| [Being API Reference](docs/specs/02-being-api-reference.md) | REST endpoints, authentication, request/response formats |
| [MCP Server](docs/specs/03-mcp-server.md) | MCP tools, connection methods, usage examples |
| [Memory & Patrol](docs/specs/04-memory-and-patrol.md) | Memory system, scene format, patrol pipeline |
| [Being Identity](docs/specs/05-being-identity.md) | Ed25519 keys, signature chain, verification |
| [Sense/Act Bridge](docs/specs/06-sense-act-bridge.md) | WebSocket Bridge, capabilities, device integration |
...
- **Telegram BYOB** — Connect your own Telegram bot to a Being (free)
